...
<summary>Sınav Modülü Nedir?</summary>

**Sınav Modülü (Ölçme ve Değerlendirme Sistemi);** kurum içi eğitimlerin, oryantasyon süreçlerinin veya teknik yol haritalarının ardından çalışanların edindiği bilgileri ve yetkinlikleri ölçmek için kullanılan merkezi bir dijital test merkezidir.

</details>

<details>

<summary>Sınav Kütüphanesi Nedir ve Nasıl Kullanılır?</summary>

Sınav Kütüphanesi, tamamladığınız eğitimlerin ardından yetkinliklerinizi tescillemek veya kurum içi değerlendirmelere katılmak için giriş yaptığınız alandır. Bu ekranda, şirketiniz tarafından size tanımlanan tüm aktif, süresi geçmiş veya tamamlanmış sınavlar interaktif Sınav Kartları şeklinde listelenir.
...
<summary>Sınav Kartlarındaki "Online" ve "Gözetmenli Online" Türleri Arasındaki Fark Nedir?</summary>

Bu etiketler sınavın uygulanma metodolojisini belirtir:

* Online: Çalışanın belirlenen tarih aralığında, herhangi bir harici denetim olmadan testi uzaktan tamamlayabileceği serbest sınav türüdür.
* Gözetmenli Online: Güvenlik ve ölçme-değerlendirme standartlarının yüksek olduğu, adayın tarayıcı kısıtlamaları veya yapay zekâ/kamera denetimi altında tamamlamak zorunda olduğu resmi sınav türüdür.
