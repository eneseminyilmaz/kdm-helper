...
Çalışanların yetkinlik ve becerilerini 360 derece değerlendirme yöntemiyle ölçen; yöneticilerin, astların ve çalışma arkadaşlarının karşılıklı geri bildirimleriyle objektif bir kariyer gelişim haritası sunan yönetim modülü.
...
<summary>Değerlendirme Sonuçları Personel Tarafından Anlık Olarak Görüntüleyebilir mi?</summary>

**Hayır,** personeller devam eden değerlendirme süreçlerini anlık olarak görüntüleyemezler.
...
* **Süreç Gizliliği ve Güvenliği:** Filtre paneli, içinde bulunulan aktif çeyrek dönemini baz alarak değerlendirme yapılmasına izin verir. Ancak, değerlendirilen personel kendi ekranında yalnızca **geçmiş çeyrek dönemlerine ait (tamamlanmış ve kapanmış)** yetkinlik raporlarını görebilir. İçinde bulunulan (aktif puanlaması süren) güncel çeyreğe ait veriler, objektifliğin korunması amacıyla personelin erişimine tamamen kapalıdır.
